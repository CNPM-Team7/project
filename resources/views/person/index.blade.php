            ...
            <div class="w-full items-center divide-gray-300 divide-y divide-solid">
                ...
                <div class="h-auto w-full flex flex-row items-center pt-4 space-x-8">
                    ...
                    <div class="flex flex-row items-center">
                        <x-button-outline
                            class="text-teal-500 hover:text-white border-teal-500 hover:bg-teal-500 focus:ring-yellow-300 w-28"
                            onclick="search()">
                            Tìm kiếm
                        </x-button-outline>
                    </div>
                                ...
                                @foreach ($people as $person)
                                    <tr>
                                        ...
                                        <td data-tooltip-target="tooltip-birthday {{ $person->id_number }}"
                                            ...
                                            <div
                                                class="text-sm text-gray-900 italic">{{ date('d/m/Y', strtotime($person->birthday)) }}</div>
                                        </td>
                                        ...
                                        <td @if($person->family_id) data-tooltip-target="tooltip-family {{ $person->id_number }}"
                                            @endif
                                            class="px-6 py-4 whitespace-nowrap select-text">
                                            <div class="flex items-center">
                                                @if($person->family_id)
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500">{{ $person->note ?? 'Trống' }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
