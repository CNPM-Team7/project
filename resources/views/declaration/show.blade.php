            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('declarations.index') }}">
                            <span class="inline-flex items-center font-medium text-sm text-gray-700 hover:text-gray-900">Thông tin dịch tễ</span>
                        </a>
                    </div>
                </li>
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm text-gray-400 md:ml-2 dark:text-gray-500">Khai báo thông tin dịch tễ</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="w-auto overflow-hidden sm:rounded-lg px-10 py-5 bg-gray-100 shadow-lg">
            <div class="w-full h-full">
                <form action="{{ route('declarations.update', $declaration->id) }}" method="POST"
                    ...
                    <div class="grid grid-cols-2 gap-x-14 gap-y-4">
                        ...
                        <div class="w-full flex flex-row items-center gap-x-2">
                            <div class="flex w-full items-center justify-between">
                                <label for="gender"
                                       class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-400">Giới
                                    tính</label>
                        ...
                        <div class="w-full flex flex-row items-center gap-x-2">
                            <div class="flex w-full items-center justify-between">
                                <label for="isolation_level"
                                       class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-400">Mức độ
                                    cách
                                    ly</label>
                            ...
                            <div class="flex w-full items-center justify-between gap-x-2">
                                ...
                                <div class="relative w-7/12 flex flex-row gap-x-2">
                                    ...
                                    <input name="isolation_date" datepicker="" datepicker-format="dd/mm/yyyy"
                                           type="text"
                                           value="{{ date('d/m/Y',strtotime($declaration->isolation_date)) }}"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 datepicker-input"
                                    >
                                </div>
                            </div>
                            ...
                            <div class="flex w-full items-center justify-between gap-x-2">
                                ...
                                <div class="relative w-7/12 flex flex-row gap-x-2">
                                    ...
                                    <input name="test_date" datepicker="" datepicker-format="dd/mm/yyyy" type="text"
                                           value="{{ date('d/m/Y',strtotime($declaration->test_date)) }}"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 datepicker-input"
                                    >
                                </div>
                            </div>
                    ...
                    <input id="health_state" name="health_state" value="{{ $declaration->health_state ?? '{}' }}"
                           style="display: none;"/>
                    <div>
                        <p class="text-base font-medium text-gray-900 inline mb-2 dark:text-gray-400">
                            Theo vòng 14 ngày qua, Anh/Chị có đến khu vực, tỉnh, thành phố, quốc gia/vùng lãnh thổ nào
                            có
                            dịch?
                        </p>
                        ...
                        <label for="No"
                               class="text-sm font-medium text-gray-900 mb-2 mr-2 dark:text-gray-400">Không</label>
                    ...
                    <div>
                        <p for="cough_status"
                           class="text-base font-medium text-gray-900 inline mb-2 dark:text-gray-400">
