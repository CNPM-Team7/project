...
@section('content')
    {{-- TODO show moi thong tin trong DB, them button de edit va delete--}}
    @if($person->family_id)
        <div> {{-- TODO pretify these --}}
            ID Ho Khau: {{ $person->family_id }} {{-- TODO nhan vao se chuyen den trang show family --}}
        </div>
        <div>
        ...
        <div>Cac thanh vien khac trong Ho Khau:</div>
        @php
